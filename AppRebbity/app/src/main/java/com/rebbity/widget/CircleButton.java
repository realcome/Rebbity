...
public class CircleButton extends ImageView {
	...
	// by tyler
	private boolean mHasBgBeforePress;
	...
	public void setColor(int color) {
		...
		if(this.mHasBgBeforePress == false){
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			this.mHasBgBeforePress = a.getBoolean(R.styleable.CircleButton_cb_hasBgBeforePress, false);
			a.recycle();
		}
